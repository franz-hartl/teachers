      ...
      <div className="container region-content">
        <div className="row">
          <div className="col-sm-9 mt-3">
            ...
            <p className="article_author">By James R.Vivian</p>
            <div className="article_table_contents">
              <p className="article_table_contents_header">Contents:</p>
              <p>
                <a href="#a">Background</a>
              </p>
              <p>
                <a href="#b">The Program</a>
              </p>
              <p>
                <a href="#c">The Institute's Governing Principles</a>
              </p>
              <p>
                <a href="#d">Recommendations</a>
              </p>
            </div>
            <div className="article-row">
              <a name="a" />
              <h2 className="article-section-header">Background</h2>
              <p>
            ...
            <div className="article-row">
              <a name="b" />
              <h2 className="article-section-header">The Program</h2>
              <p>
