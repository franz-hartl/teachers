      ...
      <div className="container region-content">
        <div className="row">
          <div className="col-sm-9 mt-3">
            <h1 className="page-title title">Partnerships and the Community</h1>
            ...
            <div className="article-row">
              <h2 className="article-section-header">VIVIAN:</h2>
              <p>
              ...
              <p>
                ...
                pervasive concern in our collaborative work.{' '}
              </p>
              <p>
                {' '}
