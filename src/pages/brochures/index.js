        ...
        <div className="row mt-4">
          ...
          <div className="col-sm-6 right-panel">
            <div className="br-cell py-2">
              ...
              <p>
              After exploring during 1997 the feasibility and desirability of establishing new Teachers Institutes at other locations, the Teachers Institute undertook a National Demonstration Project to demonstrate the feasibility of adapting at other sites the approach to teachers’ professional development that had been followed for more than two decades by the Yale-New Haven Teachers Institute.{' '}
              </p>
            </div>
          </div>
          <div className="row" />
