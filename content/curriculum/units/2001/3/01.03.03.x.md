...
Finally, each student will develop a poem using the form "I am proud of myself **_" and/or "I feel proud when _**." More than one response will be encouraged, along with the use of descriptive language, repetition, and any other element of poetry that is appropriate to what they write. These poems will be shared with others and should be part of the team's culminating activity.
