      ...
      <div class="container region-content">
        <div class="row">
          <div class="col-sm-9 mt-3">
            ...
            <div class="article-row">
              <a name="d" />
              <h2 class="article-section-header">A Vested Interest</h2>
              <p>               
            ...
            <div class="article-row">
              <a name="e" />
              <h2 class="article-section-header">Governing Principles</h2>
              <p>               
              ...
              <h3 class="article_h3">Collegiality</h3>
              <p>               
              ...
              <h3 class="article_h3">Teacher Leadership</h3>
              <p>                
              ...
              <h3 class="article_h3">Long-term Collaboration</h3>
              <p>             
              ...
              <h3 class="article_h3">Curriculum development</h3>
              <p>
            ...
            <div class="article-row">
              <a name="f" />
              <h2 class="article-section-header">Finance</h2>
              <p>               
            ...
            <div class="article-row">
              <a name="g" />
              <h2 class="article-section-header">Evaluation</h2>
              <p>              
              ...
              <h3 class="article_h3">Consultants</h3>
              <p>
              ...
              <h3 class="article_h3">District-wide study</h3>
              <p>
            ...
            <p>             
              ...
              <h3 class="article_h3">Definitions</h3>
              <p>
              ...
              <h3 class="article_h3">Resources</h3>
              <p>
              ...
              <h3 class="article_h3">Limitations</h3>
              <p>
              ...
              <h3 class="article_h3">Evaluation</h3>
              <p>
              ...
              <h3 class="article_h3">Duration</h3>
              <p>
            ...
            <div class="article-row">
              <a name="i" />
              <h2 class="article-section-header">References</h2>Boyer, E. L.
